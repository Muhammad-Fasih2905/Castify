...
const OtherAllUsers = ({setShowAllUsers1, showAllUsers1}) => {
  const navigation = useNavigation();

  const [isFollow, setIsFollow] = useState(showAllUsers1.is_follower || false);
  ...
  return (
    <View>
      <View style={{...styles.Newheader}}>
        <View flex={0.2}>
          <TouchableOpacity onPress={() => setShowAllUsers1(false)}>
