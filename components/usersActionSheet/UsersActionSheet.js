...
const UsersActionSheet = ({onOpen, isOpen, onClose, allFollowUsers}) => {
                      ...
                      <View style={styles.NewMessageBox}>
                        ...
                        <Text
                          ...
                          {item?.senderID?.category
                            ? item?.senderID?.category.charAt(0).toUpperCase() +
                              item?.senderID?.category.slice(1)
                            : ''}
                        </Text>
                      </View>
                    </VStack>
...
export default UsersActionSheet;
