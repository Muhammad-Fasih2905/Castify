...
const TalentUserShowPortfilo = ({route}) => {
  ...
  const openProfileModal = imageIndex => {
    setselectedProfile(
      imageIndex !== null
        ...
        : profile_pic.uri || get_portfilo?.user?.pic,
    );
    ...
    <ScrollView
      ...
      <Animatable.View
        ...
        <View style={{flex: 1, alignSelf: 'center', top: 20, zIndex: 1}}>
          <TouchableOpacity
            onPress={() => {
              if (user.role || userData?.role === '1') {
                setModalShow1(false);
              } else {
                setModalShow1(true);
              }
            }}>
            {profile_pic?.uri || get_portfilo?.profile_pic || userData?.pic ? (
      ...
      <Animatable.View
        ...
        <View
          ...
          {user.role || userData?.role === '1' ? null : (
            <>
              <View
                style={{
                  flex: 1,
      ...
      <Modal
        ...
        <View style={{flex: 1, flexDirection: 'column', paddingVertical: 30}}>
          {user?.role === '1' || userData?.role ? null : (
            <>
      ...
      <Modal
        ...
        <View style={{flex: 1, flexDirection: 'column', paddingVertical: 30}}>
          {userData?.role || user?.role === '1' ? null : (
            <>
...
export default TalentUserShowPortfilo;
